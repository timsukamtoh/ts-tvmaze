    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    showsResults = _a.sent();
                    shows = showsResults.data.map(function (result) {
                        var _a = result.show, id = _a.id, name = _a.name, summary = _a.summary, image = _a.image;
                        var imgSrc = image === null ? DEFAULT_IMG : image.medium; // url to global
                        return { id: id, name: name, summary: summary, imgSrc: imgSrc };
                    });
...
function populateShows(shows) {
    ...
    for (var _i = 0, shows_1 = shows; _i < shows_1.length; _i++) {
        var _a = shows_1[_i], id = _a.id, name_1 = _a.name, summary = _a.summary, imgSrc = _a.imgSrc;
        var $show = $("<div data-show-id=\"".concat(id, "\" class=\"Show col-md-12 col-lg-6 mb-4\">\n         <div class=\"media\">\n           <img\n              src=").concat(imgSrc, "\n              alt=").concat(name_1, "\n              class=\"w-25 me-3\">\n           <div class=\"media-body\">\n             <h5 class=\"text-primary\">").concat(name_1, "</h5>\n             <div><small>").concat(summary, "</small></div>\n             <button class=\"btn btn-outline-light btn-sm Show-getEpisodes\">\n               Episodes\n             </button>\n           </div>\n         </div>\n       </div>\n      "));
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var episodeResults, episodeList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("".concat(BASE_URL, "/shows/").concat(id, "/episodes"))];
                case 1:
                    episodeResults = _a.sent();
                    episodeList = episodeResults.data.map(function (episode) {
...
function populateEpisodes(episodes) {
    $episodesList.empty();
    for (var _i = 0, _a = Array.from(episodes); _i < _a.length; _i++) {
        var _b = _a[_i], name_2 = _b.name, season = _b.season, number = _b.number;
        $episodesList.append("<li>".concat(name_2, " (season ").concat(season, ", number ").concat(number, ")</li>"));
    }
}
/**
